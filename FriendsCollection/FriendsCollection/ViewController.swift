...
//            downloaded(from: url, contentMode: mode)
//        }
        //let asd = "https://randomuser.me/api/portraits/men/9.jpg"
        let urlString = "https://randomuser.me/api/portraits/thumb/women/81.jpg" //+ (friendsArray[indexPath.row].picture?.thumbnail)!
      //  let urll = urlString // + (friendsArray[indexPath.row].picture?.thumbnail)!
        //urlString + (friendsArray[indexPath.row].picture?.thumbnail)!
        sell.images.downloaded(from: urlString)
        //sell.image.downloaded(from: asd)
